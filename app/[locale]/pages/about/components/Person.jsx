...
const Person = () => {
  return (
    <div className='flex flex-col lg:flex-row justify-center items-center w-4/5 lg:w-11/12 text-center gap-[55px] lg:gap-[35px] mt-[50px] lg:mt-[100px]'>

      <div className='flex flex-col w-full md:w-2/3 lg:w-1/3 items-center justify-center gap-[15px]'>
      <div className='flex flex-col relative items-center justify-center text-white leading-normal w-full xl:h-[600px] lg:h-[500px] h-[400px] bg-center bg-cover' style={{ backgroundImage: `url(${sahibi.src})` }}>
      ...
      <div className='flex flex-col w-full md:w-2/3 lg:w-1/3 items-center justify-center gap-[15px]'>
      <div className='flex flex-col items-center justify-center text-white leading-normal w-full xl:h-[600px] lg:h-[500px] h-[400px] bg-center bg-cover relative' style={{ backgroundImage: `url(${kizi.src})` }}>
      ...
      <div className='flex flex-col w-full md:w-2/3 lg:w-1/3 items-center justify-center gap-[15px]'>
      <div className='flex flex-col relative items-center justify-center text-white leading-normal w-full xl:h-[600px] lg:h-[500px] h-[400px] bg-start bg-cover' style={{ backgroundImage: `url(${erkek.src})` }}>
        <div className='absolute inset-0 flex flex-col items-center justify-center opacity-0 hover:opacity-100 hover:bg-black/70 z-[1] duration-500 transition-opacity'>
        <div className='flex flex-col gap-[20px] w-2/3 items-center justify-center'>
