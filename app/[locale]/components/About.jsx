...
const About = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full">
      <div className="flex flex-col justify-center items-center lg:items-start text-center lg:text-start h-full w-4/5 md:w-3/5 lg:w-11/12 xl:w-3/4 mx-4 lg:mx-16 gap-3 lg:gap-4 mt-[30px] lg:mt-[100px]">
