  ...
  return (
    <nav className="flex fixed bg-neutral-900 z-30 w-full ">
      <div className="mx-auto min-w-full px-2 lg:px-8">
        ...
        <div className="relative hidden md:flex h-28 items-center justify-between xl:px-10 2xl:px-20 ">
          ...
          <div className="flex gap-[18px] xl:gap-14 2xl:gap-24 w-1/2 justify-center items-end text-base xl:text-lg 2xl:text-xl text-slate-100">
            ...
            <div className="relative group">
              ...
              <div className="absolute mt-2 xl:w-48 w-30 bg-white rounded-md shadow-lg z-10 opacity-0 group-hover:opacity-100 hidden group-hover:block transition-all duration-300 ease-in-out">
                <Link
                  href="/"
                  className="block py-5 px-4 text-black hover:bg-gray-300"
                >
                  Otel otomasyon sistemleri
                </Link>
                <Link
                  href="/"
                  className="block py-3 px-4 text-black no-underline hover:bg-gray-300"
                >
            ...
            <div className="relative group">
              ...
              <div className="absolute mt-2 w-48 bg-white rounded-md shadow-lg z-10 opacity-0 group-hover:opacity-100 hidden group-hover:block transition-all duration-300 ease-in-out">
                <Link
                  href="/"
                  className="block py-5 px-4 text-black hover:bg-gray-300"
                >
        ...
        <div className="md:hidden flex justify-between items-center px-6 h-28">
